  ...
  return (
    <div className="glass-panel p-6 rounded-2xl overflow-hidden shadow-[0_0_15px_rgba(239,68,68,0.03)]">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs text-text-secondary min-w-[500px] md:min-w-0">
          <thead>
            ...
            {group.standings.map((row) => {
              ...
              return (
                <tr key={row.teamId} className="hover:bg-bg-primary/50 transition-colors">
                  <td className="py-3 px-2 text-text-primary font-sans font-bold whitespace-nowrap">{player?.name || 'Unknown'}</td>
